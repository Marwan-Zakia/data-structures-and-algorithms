...
and creates 
a new list of each person's full name using the array method 'map'.
...
Write a function named addPurchases that,
 given an array of objects as input, uses reduce to find the total
...
,given the Star Wars data, below, uses reduce to return an array
