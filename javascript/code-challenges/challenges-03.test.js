...
const typeNum = (arr) => {
  // Solution code here...
let newArr =arr.filter((element => (!isNaN(element))))
...
given the snorlaxData, below, and an integer as input, uses
 filter to return an array containing all stats with a baseStat greater than the integer.
